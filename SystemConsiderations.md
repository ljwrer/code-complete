...
- 产生目标码
	...
	- 编译器和链接器
		...
		- 标准链接器
			...
			- 将一个或多个目标文件与“生成可执行程序所需的”标准代码进行链接
			- 链接多种语言生成的目标文件
	...
	- build工具
		...
		- 依赖变更分析
			...
			- 改进“编译-链接-运行”循环的耗时和可靠性

		- 直接重新build所有源文件比使用make执行大量的依赖性检查更快

			- 只要这些源代码本身是优化过的（优化头文件的内容）
...
- cygwin
- 确认一套适合所有开发者的最小工具集，并将这套工具作为起始的工具箱

### 打造你自己的编程工具

- 建造工具是编程的基本活动的一部分
- 所有大型组织都有内部工具及支持团队
- 许多组织的私有需求工具和设计工具比市场卖的还要优越
- 项目特有工具
- 脚本
...
- 每一项新的编程改革都带有些许瑕疵，创造新的工具并不能从本质上提高生产率
- 没有哪项改革成功消除了编程
- 编程从根本上说就是困难的--即使有好的工具支援

	- 编程的复杂性来自计算机编程之外的世界

- 始终需要人来填补真实世界里需要解决的问题和准备用来解决问题的计算机之间的鸿沟。这些人将会被称做程序员
- 只要有计算机，就需要能告诉计算机该去做什么的人，这一活动将会被称做编程
- 持续重塑编程的含义
